...
<div class="row justify-content-center mt-5">
  <div class="col-xl-10">
    ...
    @include('genre.components.modal-create')
    @include('genre.components.modal-edit')
    @include('genre.components.modal-delete')
...
@endsection
@push('script')
<script src="{{ asset('js/genrecrud.js') }}" type="text/javascript"></script> 
@endpush